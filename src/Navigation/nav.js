  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-white bg-white fixed-top">
      <div className="container">
        ...
        <div
          className="logo"
          onClick={() => displayTitle("Trang chủ | Donaton")}
        >
        ...
        >
          <ul className="navbar-nav">
            <li
              ...
              onClick={() => displayTitle("Trang chủ | Donation")}
            >
            ...
            <li
              className="nav-item px-2"
              onClick={() => displayTitle("Dự án | Donation")}
            >
            ...
            <li
              className="nav-item px-2"
              onClick={() => displayTitle("Bài viết | Donation")}
            >
            ...
            <li
              className="nav-item px-2"
              onClick={() => displayTitle("Về chúng tôi | Donation")}
            >
          ...
          <ul className="navbar-nav align-items-lg-center  gap-3">
            ...
            {username ? (
              ...
              <>
                <li
                  className="nav-item ms-6"
                  onClick={() => displayTitle("Đăng nhập | Donation")}
                >
